// assets/js/server.js - Admin-Citizen Chat with NID Validation
...
// In-memory state
const onlineUsers = new Set(); // Anonymous chat users
...
function broadcastOnlineCount() {
  ...
  console.log(`📊 Anonymous chat users: ${onlineUsers.size}`);
}
...
io.on('connection', (socket) => {
  ...
  // Add to online users (anonymous chat)
  ...
  // ✅ Citizen join with NID validation
  ...
  // ✅ Admin requests chat history for a citizen
  ...
  // Request admin chat history (for citizen)
...
app.get('/', (req, res) => {
  res.json({
    ...
    totalChatHistories: chatHistory.size
  });
});
...
server.listen(PORT, HOST, () => {
  ...
  console.log('║   - Admin-Citizen Chat                 ║');
  console.log('║   - Persistent Chat History            ║');
  console.log('║   - NID Validation                     ║');
  console.log('╚════════════════════════════════════════╝');
});
